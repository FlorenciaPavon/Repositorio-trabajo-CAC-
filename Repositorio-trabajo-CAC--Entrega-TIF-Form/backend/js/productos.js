...
createApp({
  data() {
    ...
    return {
      ...
      url: "https://nanicompras.pythonanywhere.com/productos", // URL del backend donde se encuentran los productos
      // imgUrl: "https://nanicompras.pythonanywhere.com/static/", //url del backend con imagenes
      error: false,
      cargando: true,
      ...
      fetch(url)
        ...
        .then((data) => {
          ...
          this.productos = data.map((producto) => {
            // carga la imagen usando el url
            producto.imagen = `https://nanicompras.pythonanywhere.com/static/${producto.imagen}`;
            return producto;
          });
          this.cargando = false;
        })
